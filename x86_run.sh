...
gcc -O2 -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -L${JAVA_HOME}/jre/lib/amd64/server -fPIC -shared -lpthread -o x86/libadd.so add.c
g++ -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -L./x86 -ltls -ltls2 -ldl -lpthread -o jvm_launcher jvm_launcher.cpp
gcc -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -L./x86 -ldl -rdynamic -o main main.c
